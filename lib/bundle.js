...
class Grid{
  ...
  updateGrid(pos, DyCell){
    if(DyCell.collision){
      ...
      // this is a test
      this.scoreChanging += DyCell.value * 2;
  ...
  intervalFunction(){
    ...
    this.score += this.scoreChanging;
    this.scoreChanging = 0;
    document.getElementsByTagName('span')[0].innerHTML = `<span> score : ${this.score}</span>`;
  ...
  gameOverPage(){
    ...
    this.ctx.fillText('your score is ' + this.score, 200, 200);
